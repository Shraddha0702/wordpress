...
{
     //wp_enqueue_script('api-custom',get_template_directory_uri().'/js/custom_API.js',NULL,1.0,true);
    //wp_enqueue_script( 'api-custom-js', get_template_directory_uri() . '/js/custom_API.js', NULL, 1.0, true );
    wp_enqueue_script( 'api-custom-js', get_template_directory_uri() . '/js/custom_API.js', NULL, 1.0, true );
