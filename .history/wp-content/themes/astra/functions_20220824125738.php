...
add_action ( 'wp_ajax_' . 'AddUpdateItemCategoryProcess', 'AddUpdateItemCategoryProcess' );
add_action ( 'wp_ajax_nopriv_' . 'AddUpdateItemCategoryProcess', 'AddUpdateItemCategoryProcess' );
...
/*	$curl = curl_init('https://sandbox.dev.clover.com/v3/merchants/BHDGGQDRHGBP1/categories');
	...
	$access_token="357fab73-44bd-a2d8-8ac0-b81b7dc6ac6d";
